...
SECRET_KEY = 'django-insecure-yhosp1-0@e(8ctb=ss^_*@-49f7lvegpq-jpsvwj9$gfv737t&'
...
LOGIN_REDIRECT_URL = 'index'  # URL para onde redirecionar após o login
LOGOUT_REDIRECT_URL = 'index'  # URL para onde redirecionar após o logout
